...
<figure style="text-align: center;">
  <img src="../images/miniforge-install-options.png" alt="Options d'installation Miniforge3" width="500" style="margin: 20px 0;">
  <figcaption style="font-style: italic; color: #666; margin-top: 10px;">Figure 1 : Options d'installation - Cochez "Register Miniforge3 as the system Python 3.12" pour permettre à VSCode et autres programmes de détecter automatiquement Miniforge</figcaption>
</figure>
